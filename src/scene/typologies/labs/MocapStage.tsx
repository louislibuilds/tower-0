...
/** 004 · Mocap Stage — ring light + skeleton + CNN tensor stack */
export function MocapStage({ theme, accent, entered, active }: TypologyProps) {
  ...
  return (
    <group>
      ...
      {/* CNN / tensor stack — fed by B2 AI riser */}
      <group position={[0.06, 0.06, -0.02]}>
        {Array.from({ length: 3 }).map((_, i) => (
          <mesh key={i} position={[0, i * 0.022, 0]}>
            <boxGeometry args={[0.045 - i * 0.008, 0.018, 0.045 - i * 0.008]} />
            <meshStandardMaterial
