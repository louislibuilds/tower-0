...
function StationWorkbench({
  ...
  return (
    <>
      {/* Front work bench — Figma base slab */}
      <TypologyBpMesh box={stationBox(sx, sx, 0.2, 0, 1.5, 1, 0.62)} color={m.body} thin={thin} />

      {/* Semester terminal — vertical glass + stand (keeps Figma screen, drops arm) */}
      <TypologyBpMesh
      ...
      {/* Back packing table — Figma output tray; crates land on belt in front of it */}
      <TypologyBpMesh
